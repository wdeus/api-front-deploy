...
describe('ModalConfigComponent', () => {
  ...
  it('deve criar o componente', () => {
    ...
    const req = httpTestingController.expectOne('http://20.3.129.97:8080/filtros/fatos');
  ...
  it('deve buscar dimensões ao mudar o fato', () => {
    ...
    const req = httpTestingController.expectOne('http://20.3.129.97:8080/filtros/dimensoes?fato=Fato1');
    expect(req.request.method).toBe('GET');
    req.flush(mockResponse);
